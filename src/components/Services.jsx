    ...
    <section id="service" className="relative py-20 sm:py-24 md:py-32 bg-gradient-to-br from-slate-50 via-amber-50/20 to-slate-50 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10">
        ...
        <div className="relative max-w-6xl mx-auto">
          {/* Carousel Cards */}
          <div className="relative min-h-[420px] sm:min-h-[450px] md:min-h-[380px] mb-6">
              ...
              >
                {slides[currentSlide].map((service, index) => (
                  <motion.div
                    ...
                    className={`relative rounded-lg overflow-hidden shadow-lg border transition-all duration-300 flex flex-col ${
                      service.empty 
